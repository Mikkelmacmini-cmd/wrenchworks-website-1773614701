  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      <main className="relative mx-auto max-w-6xl px-6 pb-24 pt-8 md:px-10">
        ...
        <section id="services" className="mt-28 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {services.map((item) => (
            <article
              key={item.title}
        ...
        <section id="process" className="mt-28 rounded-3xl border border-white/15 bg-white/5 p-8 md:p-12">
        ...
        <section className="mt-28 rounded-3xl border border-white/15 bg-white/5 p-8">
        ...
        <section
          id="contact"
          className="relative mt-28 overflow-hidden rounded-3xl border border-cyan-200/25 bg-gradient-to-r from-cyan-300/10 to-violet-300/10 p-10 text-center md:p-14"
        >
          <div
