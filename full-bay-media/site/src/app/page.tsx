...
const services = [
  {
    ...
    text: "Premium websites that make your offer clear fast and drive more diagnostic call bookings.",
  },
  {
    title: "Local SEO for Service + City Intent",
    text: "Service-area page architecture, schema, and topical depth to win high-intent local searches.",
  },
  {
    title: "Review Funnel + Reputation Ops",
    text: "Automated review asks and profile optimization that compound trust every week.",
  },
];

const process = [
  "Diagnose gaps in offer clarity, trust signals, and call-flow friction",
  "Rebuild core pages with stronger messaging and cleaner visual hierarchy",
  "Deploy local SEO structure and entity-rich on-page optimization",
  "Launch review workflows tied directly to completed jobs",
];

const faq = [
  {
    q: "Who is Full Bay Media for?",
    a: "Independent auto repair shops and multi-location operators that want more qualified local leads and better close rates.",
  },
  {
    q: "How is this different from generic agency marketing?",
    a: "We focus on revenue mechanics: offer clarity, conversion UX, local search intent, and review systems that create durable demand.",
  },
  {
    q: "What happens on the diagnostic call?",
    a: "We audit your current website, local visibility, and review performance, then map out the highest-leverage changes for the next 30-60 days.",
  },
];
...
const orgLd = {
  ...
  description:
    "Full Bay Media builds premium websites, local SEO systems, and review funnels for independent auto repair shops.",
};
